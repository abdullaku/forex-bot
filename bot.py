...
# --- ڕێکخستنی سەرەتایی (Config) ڕاستەوخۆ لێرە ---
...
CHECK_INTERVAL = 300 # ٥ خولەک
POST_DELAY = 10     # ١٠ چرکە نێوان پۆستەکان
